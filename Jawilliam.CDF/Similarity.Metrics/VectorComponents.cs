...
namespace Jawilliam.Data.Mining.Simetric
{
    ...
    public static class VectorComponents
    {
        ...
        public delegate IEnumerable<T> GetComponents<T>(T[] firstSequence, T[] secondSequence, IEqualityComparer<T> comparer, out double[] firstResult, out double[] secondResult, Func<IEnumerable<T>, IEnumerable<T>, IEqualityComparer<T>, IEnumerable<T>> termSelector = null);
    }
}
