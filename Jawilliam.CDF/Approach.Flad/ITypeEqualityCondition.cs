...
{
    /// <summary>
    /// Defines a same type-based equality condition for two element versions. 
    /// </summary>
    ...
    public interface ITypeEqualityCondition<TOriginal, TModified>
    {
        /// <summary>
        ...
        bool TypeExactlyEqual(TOriginal original, TModified modified);
    }
}
