...
{
    /// <summary>
    /// Defines a same signature-based matching criterion. 
    /// </summary>
    ...
    public interface ISignatureEqualityCriterion<TElement, TOriginal, TModified>
    {
        /// <summary>
        ...
        bool SignatureEqualityMatch(TOriginal original, TModified modified, MatchingContext<TElement> context, out MatchInfo<TElement> matchingDescription);
    }
}
