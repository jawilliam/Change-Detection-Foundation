...
//    private static readonly byte POST2_SIZE = 0;
//    private static readonly byte POST2_KR_SUM = 1;
//    private static readonly byte POST2_REV_KR_SUM = 2;
//    private static readonly byte POST2_DESC_SUM = 3; // number of subforests in
//                                                  // full decomposition
//    private static readonly byte POST2_PRE = 4;
//    private static readonly byte POST2_PARENT = 5;
//    private static readonly byte POST2_LABEL = 6;
//    private static readonly byte KR = 7; // key root nodes (size of this array =
//                                      // leaf count)
//    private static readonly byte POST2_LLD = 8; // left-most leaf descendants
//    private static readonly byte POST2_MIN_KR = 9; // minimum key root nodes index
//                                                // in KR array
//    private static readonly byte RKR = 10; // reversed key root nodes
//    private static readonly byte RPOST2_RLD = 11; // reversed postorer 2 right-most
//                                               // leaf descendants
//    private static readonly byte RPOST2_MIN_RKR = 12; // minimum key root nodes
//                                                   // index in RKR array
//    private static readonly byte RPOST2_POST = 13; // reversed postorder ->
//                                                // postorder
//    private static readonly byte POST2_STRATEGY = 14; // strategy for Demaine (is
//                                                   // there sth on the
//                                                   // left/right of the heavy
//                                                   // node)
//    private static readonly byte PRE2_POST = 15; // preorder to postorder
...
//        for (int x = 0; x < sizes1.length; x++)
//        { // for all nodes of initially
//          // left tree
//            for (int y = 0; y < sizes2.length; y++)
//            { // for all nodes of
