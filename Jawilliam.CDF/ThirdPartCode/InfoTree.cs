...
//namespace Jawilliam.CDF.ThirdPartCode
//{
////    class InfoTree
////    {
////    }
...
//    private static readonly byte LEFT = 0;
//    private static readonly byte RIGHT = 1;
//    private static readonly byte HEAVY = 2;
//    private static readonly byte BOTH = 3;
//    //private static readonly byte REVLEFT = 4;
//    //private static readonly byte REVRIGHT = 5;
//    //private static readonly byte REVHEAVY = 6;

//    // constants for indeces numbers
//    public static readonly byte POST2_SIZE = 0;
//    public static readonly byte POST2_KR_SUM = 1;
//    public static readonly byte POST2_REV_KR_SUM = 2;
//    public static readonly byte POST2_DESC_SUM = 3; // number of subforests in full decomposition
//    public static readonly byte POST2_PRE = 4;
//    public static readonly byte POST2_PARENT = 5;
//    public static readonly byte POST2_LABEL = 6;
//    public static readonly byte KR = 7; // key root nodes (size of this array = leaf count)
//    public static readonly byte POST2_LLD = 8; // left-most leaf descendants
//    public static readonly byte POST2_MIN_KR = 9; // minimum key root nodes index in KR array
//    public static readonly byte RKR = 10; // reversed key root nodes
//    public static readonly byte RPOST2_RLD = 11; // reversed postorer 2 right-most leaf descendants
//    public static readonly byte RPOST2_MIN_RKR = 12;
//    public static readonly byte RPOST2_POST = 13; // reversed postorder -> postorder
//    public static readonly byte POST2_STRATEGY = 14; // strategy for Demaine (is there sth on the left/right of the heavy node)
//    public static readonly byte PRE2_POST = 15;
...
//        ArrayList<int> childrenPostorders = new ArrayList<int>();
