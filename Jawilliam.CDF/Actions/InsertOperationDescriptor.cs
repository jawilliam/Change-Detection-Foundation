...
{
    /// <summary>
    /// Represents a basic "insert" operation.
    /// </summary>
    [Serializable]
    public class InsertOperationDescriptor : OperationDescriptor
    {
        /// <summary>
        /// Gets the current action.
        /// </summary>
        public override ActionKind Action => ActionKind.Insert;
        ...
        {
            return $"Insert {Element.Label}({Element.Id}) into {this.Parent.Label}({this.Parent.Id}) at {this.Position} expanded={this.Expanded ?? false}";
        }
    }
}