...
namespace Jawilliam.CDF.Labs.Common.DBModel
{
    ...
    public enum ChangeDetectionApproaches : int
    {
        ...
        RepairedInverseNativeGTtreefiedRoslynML = 2011,
        RepairedInverseNativeGTtreefiedRoslynMLWithIncludeTrivia = 2033,
        RepairedInverseNativeGTtreefiedRoslynMLWithIncludeTriviaAndPermissiveLabeling = 2043,
        RepairedInverseNativeGTtreefiedRoslynMLAndPermissiveLabeling = 2049,
        RepairedInverseNativeGTtreefiedRoslynMLWithBasicPruning = 2029,
        RepairedInverseNativeGTtreefiedRoslynMLWithBasicPruningAndIncludeTrivia = 2031,
        RepairedInverseNativeGTtreefiedRoslynMLWithBasicPruningAndPermissiveLabeling = 2039,
        RepairedInverseNativeGTtreefiedRoslynMLWithBasicPruningAndIncludeTriviaAndPermissiveLabeling = 2041
    }
}
