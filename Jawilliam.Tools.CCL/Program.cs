...
namespace Jawilliam.Tools.CCL
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            //args = new[] { @"gumtree repaired-expand Forward 20 -trace=D:\ExperimentLogs\gumtree_repairedexpansion_10.txt -name=NativeGTtreefiedRoslynML_Forward -approach=NativeGTtreefiedRoslynML -fileFormat=5 -direction=Forward -from=1 -to=25 -onThese=D:\ExperimentLogs\OnThese2010.txt" };
