...
namespace Jawilliam.Tools.CCL
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            //args = new[] { @"gumtree repaired-expand Forward 20 -trace=D:\ExperimentLogs\gumtree_repairedexpansion_28.txt -name=NativeGTtreefiedRoslynMLWithBasicPruning_Forward -approach=NativeGTtreefiedRoslynMLWithBasicPruning -fileFormat=12 -direction=Forward -onThese=D:\ExperimentLogs\OnThese.txt -from=1 -to=1" };
            //args = new[] { @"gumtree compare RepairedNativeGTtreefiedRoslynML_Forward RepairedNativeGTtreefiedRoslynML 5 -trace=D:\ExperimentLogs\BetweenSymptoms_2010_2028.txt -name=RepairedNativeGTtreefiedRoslynMLWithBasicPruning_Forward -approach=RepairedNativeGTtreefiedRoslynMLWithBasicPruning -fileFormat=12 -direction=Forward -from=1 -to=25 -onThese=D:\ExperimentLogs\OnThese2010_2028.txt" };
            //args = new[] { @"Compare stats RepairedNativeGTtreefiedRoslynML_Forward RepairedNativeGTtreefiedRoslynML 5 -trace=D:\ExperimentLogs\BetweenSymptomsStats_2010_10_Test.txt -name=NativeGTtreefiedRoslynML_Forward -approach=NativeGTtreefiedRoslynML -fileFormat=5 -direction=Forward -from=1 -to=1 -onThese=D:\ExperimentLogs\OnThese2010_10.txt" };
