...
namespace Jawilliam.CDF.CSharp.Flad
{
    ...
    //                new MatchingDiscoveryChoice<SyntaxNode>(this,
    //                    new FingerprintMatcher<SyntaxNode, Annotation<SyntaxNode>>
    //                        (this,
    //                         a => a.FullHash,
    //                         (a, h) => a.FullHash = h,
    //                         (o, m) => new MatchInfo<SyntaxNode>((int)MatchInfoCriterions.IdenticalFullHash) { Original = o, Modified = m }))
    //                ,
    //                new MatchingTieBreakChoice<SyntaxNode, Annotation<SyntaxNode>>(this)
    //                {
    //                    Traverse = o => o.BreadthFirstOrder(this.HierarchicalAbstraction().Children),
    //                    Metric = new DiceCoefficientSimetric<SyntaxNode>()
    //                    {
    //                        AreEqual = this.MatchEquality<SyntaxNode, Annotation<SyntaxNode>>,
    //                        GetComponents = this._ByTermExistence<SyntaxNode, Annotation<SyntaxNode>>
    //                    }
    //                },
    ...
    //                //},
    //                new MatchingDiscoveryChoice<SyntaxNode>(this, new SimilarityMatcher<SyntaxNode, Annotation<SyntaxNode>>(this))
    //                {
