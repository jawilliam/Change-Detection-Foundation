...
namespace Jawilliam.CDF.CSharp.Awareness
{
    ...
    partial class LanguageServiceProvider
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description.</param>
        protected virtual bool SignatureEqualityMatch<TOriginal, TModified>(IEnumerable<TOriginal> original, IEnumerable<TModified> modified, Func<TOriginal, TModified, bool> equal, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
        where TOriginal : SyntaxNode where TModified : SyntaxNode
        {
            ...
            {
                matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original as SyntaxNode, Modified = modified as SyntaxNode };
                return true;
            }
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description.</param>
        public virtual bool SignatureEqualityMatch<TOriginal, TModified>(SeparatedSyntaxList<TOriginal> original, SeparatedSyntaxList<TModified> modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
        where TOriginal : SyntaxNode where TModified : SyntaxNode
        {
    		return this.SignatureEqualityMatch(original, modified, (o, m) => this.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", o, m, context), context, out matchingDescription);
    	}		
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description.</param>
        public virtual bool SignatureEqualityMatch<TOriginal, TModified>(SyntaxList<TOriginal> original, SyntaxList<TModified> modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
        where TOriginal : SyntaxNode where TModified : SyntaxNode
        {
    		return this.SignatureEqualityMatch(original, modified, (o, m) => this.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", o, m, context), context, out matchingDescription);
    	}
    ...
    /*
    partial class OmittedTypeArgumentServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, OmittedTypeArgumentSyntax, OmittedTypeArgumentSyntax>
    {
        /// <summary>
        /// Determines if two elements are signature-based exactly equal.
        /// </summary>
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description.</param>
        public virtual bool SignatureEqualityMatch(OmittedTypeArgumentSyntax original, OmittedTypeArgumentSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
        {
            if (original == null || modified == null)
            {
                matchingDescription = null;
    ...
    public partial class TypeParameterListServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, TypeParameterListSyntax, TypeParameterListSyntax>
    {
    	/// <summary>
        ...
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        ...
        protected virtual bool SignatureEqualityMatchCore(TypeParameterListSyntax original, TypeParameterListSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Parameters, modified.Parameters, context))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
    ...
    public partial class TypeParameterServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, TypeParameterSyntax, TypeParameterSyntax>
    {
    	/// <summary>
        ...
        protected virtual bool SignatureEqualityMatchCore(TypeParameterSyntax original, TypeParameterSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Identifier, modified.Identifier, context))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
    ...
    public partial class ConstructorInitializerServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ConstructorInitializerSyntax, ConstructorInitializerSyntax>
    {
    	/// <summary>
        ...
        protected virtual bool SignatureEqualityMatchCore(ConstructorInitializerSyntax original, ConstructorInitializerSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if ((this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ThisOrBaseKeyword, modified.ThisOrBaseKeyword, context)) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ArgumentList, modified.ArgumentList, context)))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
    ...
    public partial class ParameterServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ParameterSyntax, ParameterSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(ParameterSyntax original, ParameterSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (((original.Type == null && modified.Type == null) || (original.Type != null && modified.Type != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Type, modified.Type, context))) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Identifier, modified.Identifier, context)))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ParameterSyntax original, ParameterSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class CrefParameterServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, CrefParameterSyntax, CrefParameterSyntax>
    {
    	/// <summary>
        ...
        protected virtual bool SignatureEqualityMatchCore(CrefParameterSyntax original, CrefParameterSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Type, modified.Type, context))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
    ...
    public partial class DelegateDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, DelegateDeclarationSyntax, DelegateDeclarationSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(DelegateDeclarationSyntax original, DelegateDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if ((this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Identifier, modified.Identifier, context)) &&
                ((original.TypeParameterList == null && modified.TypeParameterList == null) || (original.TypeParameterList != null && modified.TypeParameterList != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.TypeParameterList, modified.TypeParameterList, context))) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ParameterList, modified.ParameterList, context)))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(DelegateDeclarationSyntax original, DelegateDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class ClassDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ClassDeclarationSyntax, ClassDeclarationSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ClassDeclarationSyntax original, ClassDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class StructDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, StructDeclarationSyntax, StructDeclarationSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(StructDeclarationSyntax original, StructDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class InterfaceDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, InterfaceDeclarationSyntax, InterfaceDeclarationSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(InterfaceDeclarationSyntax original, InterfaceDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class MethodDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, MethodDeclarationSyntax, MethodDeclarationSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(MethodDeclarationSyntax original, MethodDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (((original.ExplicitInterfaceSpecifier == null && modified.ExplicitInterfaceSpecifier == null) || (original.ExplicitInterfaceSpecifier != null && modified.ExplicitInterfaceSpecifier != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ExplicitInterfaceSpecifier, modified.ExplicitInterfaceSpecifier, context))) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Identifier, modified.Identifier, context)) &&
                ((original.TypeParameterList == null && modified.TypeParameterList == null) || (original.TypeParameterList != null && modified.TypeParameterList != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.TypeParameterList, modified.TypeParameterList, context))) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ParameterList, modified.ParameterList, context)))
    		{
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(MethodDeclarationSyntax original, MethodDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class OperatorDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, OperatorDeclarationSyntax, OperatorDeclarationSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(OperatorDeclarationSyntax original, OperatorDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if ((this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.OperatorToken, modified.OperatorToken, context)) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ParameterList, modified.ParameterList, context)))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(OperatorDeclarationSyntax original, OperatorDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class ConversionOperatorDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ConversionOperatorDeclarationSyntax, ConversionOperatorDeclarationSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ConversionOperatorDeclarationSyntax original, ConversionOperatorDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class ConstructorDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ConstructorDeclarationSyntax, ConstructorDeclarationSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ConstructorDeclarationSyntax original, ConstructorDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class EventDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, EventDeclarationSyntax, EventDeclarationSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(EventDeclarationSyntax original, EventDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class IndexerDeclarationServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, IndexerDeclarationSyntax, IndexerDeclarationSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(IndexerDeclarationSyntax original, IndexerDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (((original.ExplicitInterfaceSpecifier == null && modified.ExplicitInterfaceSpecifier == null) || (original.ExplicitInterfaceSpecifier != null && modified.ExplicitInterfaceSpecifier != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ExplicitInterfaceSpecifier, modified.ExplicitInterfaceSpecifier, context))) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ThisKeyword, modified.ThisKeyword, context)) &&
                (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ParameterList, modified.ParameterList, context)))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(IndexerDeclarationSyntax original, IndexerDeclarationSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class ParameterListServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ParameterListSyntax, ParameterListSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ParameterListSyntax original, ParameterListSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class BracketedParameterListServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, BracketedParameterListSyntax, BracketedParameterListSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(BracketedParameterListSyntax original, BracketedParameterListSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class NameMemberCrefServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, NameMemberCrefSyntax, NameMemberCrefSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(NameMemberCrefSyntax original, NameMemberCrefSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if ((this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Name, modified.Name, context)) &&
                ((original.Parameters == null && modified.Parameters == null) || (original.Parameters != null && modified.Parameters != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Parameters, modified.Parameters, context))))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(NameMemberCrefSyntax original, NameMemberCrefSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class IndexerMemberCrefServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, IndexerMemberCrefSyntax, IndexerMemberCrefSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(IndexerMemberCrefSyntax original, IndexerMemberCrefSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if ((this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ThisKeyword, modified.ThisKeyword, context)) &&
                ((original.Parameters == null && modified.Parameters == null) || (original.Parameters != null && modified.Parameters != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Parameters, modified.Parameters, context))))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(IndexerMemberCrefSyntax original, IndexerMemberCrefSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class OperatorMemberCrefServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, OperatorMemberCrefSyntax, OperatorMemberCrefSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(OperatorMemberCrefSyntax original, OperatorMemberCrefSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class ConversionOperatorMemberCrefServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ConversionOperatorMemberCrefSyntax, ConversionOperatorMemberCrefSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ConversionOperatorMemberCrefSyntax original, ConversionOperatorMemberCrefSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class CrefParameterListServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, CrefParameterListSyntax, CrefParameterListSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(CrefParameterListSyntax original, CrefParameterListSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class CrefBracketedParameterListServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, CrefBracketedParameterListSyntax, CrefBracketedParameterListSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(CrefBracketedParameterListSyntax original, CrefBracketedParameterListSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class AnonymousMethodExpressionServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, AnonymousMethodExpressionSyntax, AnonymousMethodExpressionSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(AnonymousMethodExpressionSyntax original, AnonymousMethodExpressionSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (original.ParameterList != null && modified.ParameterList != null && this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ParameterList, modified.ParameterList, context))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(AnonymousMethodExpressionSyntax original, AnonymousMethodExpressionSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class SimpleLambdaExpressionServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, SimpleLambdaExpressionSyntax, SimpleLambdaExpressionSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(SimpleLambdaExpressionSyntax original, SimpleLambdaExpressionSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.Parameter, modified.Parameter, context))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(SimpleLambdaExpressionSyntax original, SimpleLambdaExpressionSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class ParenthesizedLambdaExpressionServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, ParenthesizedLambdaExpressionSyntax, ParenthesizedLambdaExpressionSyntax>
    {
        ...
        protected virtual bool SignatureEqualityMatchCore(ParenthesizedLambdaExpressionSyntax original, ParenthesizedLambdaExpressionSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
            ...
            if (this.LanguageServiceProvider.MatchBy(typeof(ISignatureEqualityCriterion<,,>), "SignatureEquality", original.ParameterList, modified.ParameterList, context))
    		{
    			matchingDescription = new MatchInfo<SyntaxNodeOrToken?>((int)MatchInfoCriterions.SignatureEquality) { Original = original, Modified = modified };
    			return true;
    		}
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(ParenthesizedLambdaExpressionSyntax original, ParenthesizedLambdaExpressionSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
    ...
    public partial class LocalFunctionStatementServiceProvider : ISignatureEqualityCriterion<SyntaxNodeOrToken?, LocalFunctionStatementSyntax, LocalFunctionStatementSyntax>
    {
        ...
        /// <returns>true if the given elements are signature-based exactly equal, otherwise returns false.</returns>
        /// <param name="matchingDescription">in case the given elements are signature-based exactly equal, this parameter will contain the corresponding matching description. It should be actually an "out" parameter, but partial methods do not support "out" parameters.</param>
        public virtual bool SignatureEqualityMatch(LocalFunctionStatementSyntax original, LocalFunctionStatementSyntax modified, MatchingContext<SyntaxNodeOrToken?> context, out MatchInfo<SyntaxNodeOrToken?> matchingDescription)
    	{
    		bool result = false;
    		var ignoreCore = false;
    		matchingDescription = null;
