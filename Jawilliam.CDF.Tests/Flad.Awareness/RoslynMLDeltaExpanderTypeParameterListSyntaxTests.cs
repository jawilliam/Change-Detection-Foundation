namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TypeParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TypeParameterListSyntax> nodes);
         ...
         public void TypeParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TypeParameterListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TypeParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
