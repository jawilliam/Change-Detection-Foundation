namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="CasePatternSwitchLabelServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="CasePatternSwitchLabelSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void CasePatternSwitchLabelServiceProvider_RoslynMLDeltaExpander_OK()
         {
    		var converter = new CDF.CSharp.RoslynML.RoslynML();
    		var selector = new CDF.CSharp.RoslynML.RoslynMLPruneSelector();
    		int id = 0; 
    
    	    IEnumerable<(CasePatternSwitchLabelSyntax, CasePatternSwitchLabelSyntax)> nodeRevisionPairs = null;
    	    string oExpectedLabel = null, mExpectedLabel = null;
    	    CasePatternSwitchLabelServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
    		foreach(((CasePatternSwitchLabelSyntax Original, CasePatternSwitchLabelSyntax Modified) nodeRevisionPair, Action<RoslynML, XElement> defoliate) in nodeRevisionPairs
    			.SelectMany(n => new List<((CasePatternSwitchLabelSyntax, CasePatternSwitchLabelSyntax), Action<RoslynML, XElement>)>
