namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CasePatternSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CasePatternSwitchLabelSyntax> nodes);
         ...
         public void CasePatternSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CasePatternSwitchLabelSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CasePatternSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
