namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void PropertyDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<PropertyDeclarationSyntax> nodes);
         ...
         public void PropertyDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<PropertyDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    PropertyDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
