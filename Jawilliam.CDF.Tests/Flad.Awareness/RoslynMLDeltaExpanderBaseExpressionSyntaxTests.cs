namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BaseExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BaseExpressionSyntax> nodes);
         ...
         public void BaseExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BaseExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BaseExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
