namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AssignmentExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AssignmentExpressionSyntax> nodes);
         ...
         public void AssignmentExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AssignmentExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AssignmentExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
