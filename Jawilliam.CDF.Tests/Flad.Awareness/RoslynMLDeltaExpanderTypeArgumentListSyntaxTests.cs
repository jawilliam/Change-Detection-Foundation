namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TypeArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TypeArgumentListSyntax> nodes);
         ...
         public void TypeArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TypeArgumentListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TypeArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
