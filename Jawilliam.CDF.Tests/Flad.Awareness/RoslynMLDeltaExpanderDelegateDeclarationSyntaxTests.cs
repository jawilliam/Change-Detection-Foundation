namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void DelegateDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<DelegateDeclarationSyntax> nodes);
         ...
         public void DelegateDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<DelegateDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    DelegateDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
