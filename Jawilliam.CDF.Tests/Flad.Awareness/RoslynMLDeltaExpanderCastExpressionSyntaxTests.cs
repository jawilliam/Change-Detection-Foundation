namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CastExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CastExpressionSyntax> nodes);
         ...
         public void CastExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CastExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CastExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
