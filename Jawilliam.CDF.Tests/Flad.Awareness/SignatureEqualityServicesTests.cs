...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterListServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterListServiceProvider.SignatureEqualityMatch(a, (TypeParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterListServiceProvider.SignatureEqualityMatch(null, (TypeParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterServiceProvider.SignatureEqualityMatch(a, (TypeParameterSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterServiceProvider.SignatureEqualityMatch(null, (TypeParameterSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().TypeParameterServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(a, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(null, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(a, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(null, null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                       "    class A { } }").DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single().Parameters.Parameters[0];
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterServiceProvider.SignatureEqualityMatch(a, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterServiceProvider.SignatureEqualityMatch(null, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                       "    /// <summary> <see cref=\"operator +(ref string, out int)\"/> </summary>" + Environment.NewLine +
//                       "    class A { } }").DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single().Parameters.Parameters[0];
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(a, (DelegateDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(null, (DelegateDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(a, (DelegateDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(null, (DelegateDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().DelegateDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(a, (ClassDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(null, (ClassDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(a, (ClassDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(null, (ClassDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ClassDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(a, (StructDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(null, (StructDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(a, (StructDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(null, (StructDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().StructDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(a, (InterfaceDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(null, (InterfaceDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(a, (InterfaceDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(null, (InterfaceDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().InterfaceDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(a, (MethodDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(null, (MethodDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(a, (MethodDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(null, (MethodDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().MethodDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(a, (OperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(null, (OperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(a, (OperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(null, (OperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(a, (ConversionOperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(null, (ConversionOperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(a, (ConversionOperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(null, (ConversionOperatorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
//        }
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(a, (ConstructorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(null, (ConstructorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(a, (ConstructorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(null, (ConstructorDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConstructorDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//        //    Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().PropertyDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//        //    Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().PropertyDeclarationServiceProvider.SignatureEqualityMatch(a, (PropertyDeclarationSyntax)null, matchingContext, out matchInfo));
//        //    Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().PropertyDeclarationServiceProvider.SignatureEqualityMatch(null, (PropertyDeclarationSyntax)null, matchingContext, out matchInfo));
//        //    Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().PropertyDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//        //    Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().PropertyDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(a, (EventDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(null, (EventDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(a, (EventDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(null, (EventDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().EventDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(a, (IndexerDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(null, (IndexerDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(a, (IndexerDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(null, (IndexerDeclarationSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerDeclarationServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterListServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterListServiceProvider.SignatureEqualityMatch(a, (ParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterListServiceProvider.SignatureEqualityMatch(null, (ParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().BracketedParameterListServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().BracketedParameterListServiceProvider.SignatureEqualityMatch(a, (BracketedParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().BracketedParameterListServiceProvider.SignatureEqualityMatch(null, (BracketedParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().BracketedParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                       "    class A { } }").Members[0].DescendantNodes(descendIntoTrivia: true).OfType<NameMemberCrefSyntax>().Single();
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(a, (NameMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(null, (NameMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(a, (NameMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(null, (NameMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().NameMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(a, (IndexerMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(null, (IndexerMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(a, (IndexerMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(null, (IndexerMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().IndexerMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                       "    /// <summary> <see cref=\"operator -(int)\"/> </summary>" + Environment.NewLine +
//                       "    class A { } }").Members[0].DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single();
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, (OperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(null, (OperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, (OperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(null, (OperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().OperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
//        }
...
//                       "    class A { } }").Members[0].DescendantNodes(descendIntoTrivia: true).OfType<ConversionOperatorMemberCrefSyntax>().Single();
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, (ConversionOperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(null, (ConversionOperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, (ConversionOperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(null, (ConversionOperatorMemberCrefSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ConversionOperatorMemberCrefServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
//        }
...
//                       "    /// <summary> <see cref=\"operator +(ref string, out string)\"/> </summary>" + Environment.NewLine +
//                       "    class A { } }").DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single().Parameters;
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterListServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterListServiceProvider.SignatureEqualityMatch(a, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterListServiceProvider.SignatureEqualityMatch(null, null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                       "    /// <summary> <see cref=\"operator +(ref string, out int)\"/> </summary>" + Environment.NewLine +
//                       "    class A { } }").DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single().Parameters;
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                       "    /// <summary> <see cref=\"this[int, string]\"/> </summary>" + Environment.NewLine +
//                       "    class A { } }").Members[0].DescendantNodes(descendIntoTrivia: true).OfType<IndexerMemberCrefSyntax>().Single().Parameters;
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(a, (CrefBracketedParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(null, (CrefBracketedParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(a, (CrefBracketedParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(null, (CrefBracketedParameterListSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().CrefBracketedParameterListServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
//        }
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(a, (AnonymousMethodExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(null, (AnonymousMethodExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(a, (AnonymousMethodExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(null, (AnonymousMethodExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().AnonymousMethodExpressionServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(a, (SimpleLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(null, (SimpleLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(a, (SimpleLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(null, (SimpleLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().SimpleLambdaExpressionServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
//        }
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(a, (ParenthesizedLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(null, (ParenthesizedLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(a, (ParenthesizedLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(null, (ParenthesizedLambdaExpressionSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().ParenthesizedLambdaExpressionServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//                        int local() => 0;
//                    }").Members[0]).Body.Statements[0];
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(null, b, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(a, (LocalFunctionStatementSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(null, (LocalFunctionStatementSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
...
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(a, (LocalFunctionStatementSyntax)null, matchingContext, out matchInfo));
//            Assert.IsFalse(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(null, (LocalFunctionStatementSyntax)null, matchingContext, out matchInfo));
//            Assert.IsTrue(flad.LanguageProvider<Jawilliam.CDF.CSharp.Awareness.LanguageServiceProvider>().LocalFunctionStatementServiceProvider.SignatureEqualityMatch(a, b, matchingContext, out matchInfo));
