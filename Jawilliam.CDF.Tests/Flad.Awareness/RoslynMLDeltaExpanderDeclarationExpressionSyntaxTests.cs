namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void DeclarationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<DeclarationExpressionSyntax> nodes);
         ...
         public void DeclarationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<DeclarationExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    DeclarationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
