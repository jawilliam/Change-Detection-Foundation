namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AttributeTargetSpecifierServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AttributeTargetSpecifierSyntax> nodes);
         ...
         public void AttributeTargetSpecifierServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AttributeTargetSpecifierSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AttributeTargetSpecifierServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
