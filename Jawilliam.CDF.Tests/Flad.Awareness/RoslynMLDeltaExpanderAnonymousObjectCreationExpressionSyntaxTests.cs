namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AnonymousObjectCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AnonymousObjectCreationExpressionSyntax> nodes);
         ...
         public void AnonymousObjectCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AnonymousObjectCreationExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AnonymousObjectCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
