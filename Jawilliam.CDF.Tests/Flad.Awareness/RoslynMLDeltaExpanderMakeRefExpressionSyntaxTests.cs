namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void MakeRefExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<MakeRefExpressionSyntax> nodes);
         ...
         public void MakeRefExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<MakeRefExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    MakeRefExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
