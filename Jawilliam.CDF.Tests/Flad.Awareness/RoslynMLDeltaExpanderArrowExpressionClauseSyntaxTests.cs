namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ArrowExpressionClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ArrowExpressionClauseSyntax> nodes);
         ...
         public void ArrowExpressionClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ArrowExpressionClauseSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ArrowExpressionClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
