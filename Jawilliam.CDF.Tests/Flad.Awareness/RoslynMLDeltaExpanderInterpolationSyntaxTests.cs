namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void InterpolationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<InterpolationSyntax> nodes);
         ...
         public void InterpolationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<InterpolationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    InterpolationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
