namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void StructDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<StructDeclarationSyntax> nodes);
         ...
         public void StructDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<StructDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    StructDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
