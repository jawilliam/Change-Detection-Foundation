namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ParameterListSyntax> nodes);
         ...
         public void ParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ParameterListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
