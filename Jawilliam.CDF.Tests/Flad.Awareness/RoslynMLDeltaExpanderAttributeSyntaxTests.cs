namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AttributeSyntax> nodes);
         ...
         public void AttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AttributeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
