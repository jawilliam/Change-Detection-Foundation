namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void FieldDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<FieldDeclarationSyntax> nodes);
         ...
         public void FieldDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<FieldDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    FieldDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
