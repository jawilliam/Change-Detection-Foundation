namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BinaryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BinaryExpressionSyntax> nodes);
         ...
         public void BinaryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BinaryExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BinaryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
