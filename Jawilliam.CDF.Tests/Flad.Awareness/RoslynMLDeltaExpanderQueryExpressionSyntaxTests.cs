namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void QueryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<QueryExpressionSyntax> nodes);
         ...
         public void QueryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<QueryExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    QueryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
