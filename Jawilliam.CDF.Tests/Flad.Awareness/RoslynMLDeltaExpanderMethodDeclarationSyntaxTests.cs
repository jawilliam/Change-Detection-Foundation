namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void MethodDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<MethodDeclarationSyntax> nodes);
         ...
         public void MethodDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<MethodDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    MethodDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
