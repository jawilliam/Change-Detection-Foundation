namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void XmlTextServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<XmlTextSyntax> nodes);
         ...
         public void XmlTextServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<XmlTextSyntax> nodes = null;
    	    string expectedLabel = null;
    	    XmlTextServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
