namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ArgumentListSyntax> nodes);
         ...
         public void ArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ArgumentListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
