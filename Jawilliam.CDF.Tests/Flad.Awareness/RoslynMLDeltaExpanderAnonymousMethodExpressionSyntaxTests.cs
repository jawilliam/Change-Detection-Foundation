namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="AnonymousMethodExpressionServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="AnonymousMethodExpressionSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void AnonymousMethodExpressionServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    AnonymousMethodExpressionServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
