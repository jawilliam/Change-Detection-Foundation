namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void JoinIntoClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<JoinIntoClauseSyntax> nodes);
         ...
         public void JoinIntoClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<JoinIntoClauseSyntax> nodes = null;
    	    string expectedLabel = null;
    	    JoinIntoClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
