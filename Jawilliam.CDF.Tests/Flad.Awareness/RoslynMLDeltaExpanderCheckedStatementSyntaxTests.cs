namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CheckedStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CheckedStatementSyntax> nodes);
         ...
         public void CheckedStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CheckedStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CheckedStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
