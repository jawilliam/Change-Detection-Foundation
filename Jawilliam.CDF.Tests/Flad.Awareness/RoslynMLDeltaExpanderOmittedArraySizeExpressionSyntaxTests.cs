namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="OmittedArraySizeExpressionServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="OmittedArraySizeExpressionSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void OmittedArraySizeExpressionServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    OmittedArraySizeExpressionServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
