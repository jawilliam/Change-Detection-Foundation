namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void XmlTextAttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<XmlTextAttributeSyntax> nodes);
         ...
         public void XmlTextAttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<XmlTextAttributeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    XmlTextAttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
