namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ObjectCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ObjectCreationExpressionSyntax> nodes);
         ...
         public void ObjectCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ObjectCreationExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ObjectCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
