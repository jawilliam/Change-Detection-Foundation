namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void SizeOfExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<SizeOfExpressionSyntax> nodes);
         ...
         public void SizeOfExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<SizeOfExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    SizeOfExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
