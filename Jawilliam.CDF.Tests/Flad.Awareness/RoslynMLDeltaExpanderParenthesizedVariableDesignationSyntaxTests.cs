namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ParenthesizedVariableDesignationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ParenthesizedVariableDesignationSyntax> nodes);
         ...
         public void ParenthesizedVariableDesignationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ParenthesizedVariableDesignationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ParenthesizedVariableDesignationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
