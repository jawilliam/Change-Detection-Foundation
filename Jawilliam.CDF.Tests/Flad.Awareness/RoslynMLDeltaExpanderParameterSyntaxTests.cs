namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ParameterServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ParameterSyntax> nodes);
         ...
         public void ParameterServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ParameterSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ParameterServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
