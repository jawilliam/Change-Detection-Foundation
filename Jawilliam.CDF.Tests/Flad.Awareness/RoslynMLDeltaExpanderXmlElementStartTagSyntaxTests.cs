namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void XmlElementStartTagServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<XmlElementStartTagSyntax> nodes);
         ...
         public void XmlElementStartTagServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<XmlElementStartTagSyntax> nodes = null;
    	    string expectedLabel = null;
    	    XmlElementStartTagServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
