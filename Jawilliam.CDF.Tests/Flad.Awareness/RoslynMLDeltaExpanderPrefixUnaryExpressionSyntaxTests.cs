namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void PrefixUnaryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<PrefixUnaryExpressionSyntax> nodes);
         ...
         public void PrefixUnaryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<PrefixUnaryExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    PrefixUnaryExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
