namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void RefTypeExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<RefTypeExpressionSyntax> nodes);
         ...
         public void RefTypeExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<RefTypeExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    RefTypeExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
