namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void EnumMemberDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<EnumMemberDeclarationSyntax> nodes);
         ...
         public void EnumMemberDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<EnumMemberDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    EnumMemberDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
