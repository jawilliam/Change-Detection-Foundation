namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ImplicitElementAccessServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ImplicitElementAccessSyntax> nodes);
         ...
         public void ImplicitElementAccessServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ImplicitElementAccessSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ImplicitElementAccessServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
