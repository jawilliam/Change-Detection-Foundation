namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="ConversionOperatorDeclarationServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="ConversionOperatorDeclarationSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void ConversionOperatorDeclarationServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    ConversionOperatorDeclarationServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
