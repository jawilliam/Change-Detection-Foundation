namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CaseSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CaseSwitchLabelSyntax> nodes);
         ...
         public void CaseSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CaseSwitchLabelSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CaseSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
