namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void DefaultExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<DefaultExpressionSyntax> nodes);
         ...
         public void DefaultExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<DefaultExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    DefaultExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
