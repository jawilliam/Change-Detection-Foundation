namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="ConditionalExpressionServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="ConditionalExpressionSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void ConditionalExpressionServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    ConditionalExpressionServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
