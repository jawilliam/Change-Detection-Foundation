namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ElementBindingExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ElementBindingExpressionSyntax> nodes);
         ...
         public void ElementBindingExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ElementBindingExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ElementBindingExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
