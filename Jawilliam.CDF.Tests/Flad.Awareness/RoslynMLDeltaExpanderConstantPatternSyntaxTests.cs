namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ConstantPatternServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ConstantPatternSyntax> nodes);
         ...
         public void ConstantPatternServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ConstantPatternSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ConstantPatternServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
