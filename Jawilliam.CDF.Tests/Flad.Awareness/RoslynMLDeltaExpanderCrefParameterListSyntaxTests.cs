namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CrefParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CrefParameterListSyntax> nodes);
         ...
         public void CrefParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CrefParameterListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CrefParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
