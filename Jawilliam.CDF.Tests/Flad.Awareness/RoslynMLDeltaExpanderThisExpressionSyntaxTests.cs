namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ThisExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ThisExpressionSyntax> nodes);
         ...
         public void ThisExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ThisExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ThisExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
