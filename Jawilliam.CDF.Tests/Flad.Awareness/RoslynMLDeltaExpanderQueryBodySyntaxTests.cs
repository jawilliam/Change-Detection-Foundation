namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void QueryBodyServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<QueryBodySyntax> nodes);
         ...
         public void QueryBodyServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<QueryBodySyntax> nodes = null;
    	    string expectedLabel = null;
    	    QueryBodyServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
