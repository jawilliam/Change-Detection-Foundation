namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CheckedExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CheckedExpressionSyntax> nodes);
         ...
         public void CheckedExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CheckedExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CheckedExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
