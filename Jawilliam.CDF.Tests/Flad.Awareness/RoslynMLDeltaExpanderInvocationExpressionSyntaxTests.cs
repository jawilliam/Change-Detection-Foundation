namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void InvocationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<InvocationExpressionSyntax> nodes);
         ...
         public void InvocationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<InvocationExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    InvocationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
