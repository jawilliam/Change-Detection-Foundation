namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void VariableDeclaratorServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<VariableDeclaratorSyntax> nodes);
         ...
         public void VariableDeclaratorServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<VariableDeclaratorSyntax> nodes = null;
    	    string expectedLabel = null;
    	    VariableDeclaratorServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
