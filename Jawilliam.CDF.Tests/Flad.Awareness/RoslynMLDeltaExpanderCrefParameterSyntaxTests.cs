namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    partial class RoslynMLDeltaExpanderTests
    {
         ...
         public void CrefParameterServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    CrefParameterServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodeRevisionPairs);
    				...
    				{ (n, (r, n1) => { }), (n, (r, n1) => r.Defoliate(n1)) }))
    		{
    			...
    			existingProperties = (oFullElement.Elements().Any(e => e.Label() == "RefKindKeyword") &&
