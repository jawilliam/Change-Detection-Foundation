namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ArrayTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ArrayTypeSyntax> nodes);
         ...
         public void ArrayTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ArrayTypeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ArrayTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
