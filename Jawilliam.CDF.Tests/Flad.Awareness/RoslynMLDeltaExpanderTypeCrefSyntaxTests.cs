namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TypeCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TypeCrefSyntax> nodes);
         ...
         public void TypeCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TypeCrefSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TypeCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
