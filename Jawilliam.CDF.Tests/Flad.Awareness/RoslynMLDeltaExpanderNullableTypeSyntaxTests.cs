namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void NullableTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<NullableTypeSyntax> nodes);
         ...
         public void NullableTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<NullableTypeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    NullableTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
