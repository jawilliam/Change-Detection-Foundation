namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void WhereClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<WhereClauseSyntax> nodes);
         ...
         public void WhereClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<WhereClauseSyntax> nodes = null;
    	    string expectedLabel = null;
    	    WhereClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
