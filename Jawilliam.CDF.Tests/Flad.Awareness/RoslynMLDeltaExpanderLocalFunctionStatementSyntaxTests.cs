namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void LocalFunctionStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<LocalFunctionStatementSyntax> nodes);
         ...
         public void LocalFunctionStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<LocalFunctionStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    LocalFunctionStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
