namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void WarningDirectiveTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<WarningDirectiveTriviaSyntax> nodes);
         ...
         public void WarningDirectiveTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<WarningDirectiveTriviaSyntax> nodes = null;
    	    string expectedLabel = null;
    	    WarningDirectiveTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
