namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void WhenClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<WhenClauseSyntax> nodes);
         ...
         public void WhenClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<WhenClauseSyntax> nodes = null;
    	    string expectedLabel = null;
    	    WhenClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
