namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AccessorListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AccessorListSyntax> nodes);
         ...
         public void AccessorListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AccessorListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AccessorListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
