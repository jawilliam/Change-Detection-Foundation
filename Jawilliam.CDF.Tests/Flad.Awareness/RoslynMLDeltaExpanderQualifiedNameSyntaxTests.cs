namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void QualifiedNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<QualifiedNameSyntax> nodes);
         ...
         public void QualifiedNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<QualifiedNameSyntax> nodes = null;
    	    string expectedLabel = null;
    	    QualifiedNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
