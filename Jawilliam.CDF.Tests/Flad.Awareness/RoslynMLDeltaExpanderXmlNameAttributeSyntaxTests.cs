namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void XmlNameAttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<XmlNameAttributeSyntax> nodes);
         ...
         public void XmlNameAttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<XmlNameAttributeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    XmlNameAttributeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
