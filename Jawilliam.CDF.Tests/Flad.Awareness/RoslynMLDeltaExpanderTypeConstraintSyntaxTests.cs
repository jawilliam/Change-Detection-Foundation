namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TypeConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TypeConstraintSyntax> nodes);
         ...
         public void TypeConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TypeConstraintSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TypeConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
