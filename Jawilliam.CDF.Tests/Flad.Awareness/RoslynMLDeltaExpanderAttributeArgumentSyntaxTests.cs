namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AttributeArgumentServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AttributeArgumentSyntax> nodes);
         ...
         public void AttributeArgumentServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AttributeArgumentSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AttributeArgumentServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
