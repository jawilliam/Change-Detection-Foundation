namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CrefBracketedParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CrefBracketedParameterListSyntax> nodes);
         ...
         public void CrefBracketedParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CrefBracketedParameterListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CrefBracketedParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
