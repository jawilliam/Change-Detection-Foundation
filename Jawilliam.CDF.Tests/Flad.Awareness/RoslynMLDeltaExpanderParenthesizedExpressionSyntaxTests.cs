namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ParenthesizedExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ParenthesizedExpressionSyntax> nodes);
         ...
         public void ParenthesizedExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ParenthesizedExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ParenthesizedExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
