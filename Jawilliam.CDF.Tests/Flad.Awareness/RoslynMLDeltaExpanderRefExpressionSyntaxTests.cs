namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void RefExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<RefExpressionSyntax> nodes);
         ...
         public void RefExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<RefExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    RefExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
