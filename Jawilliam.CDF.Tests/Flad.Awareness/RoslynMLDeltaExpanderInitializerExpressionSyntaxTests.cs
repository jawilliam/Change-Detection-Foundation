namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void InitializerExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<InitializerExpressionSyntax> nodes);
         ...
         public void InitializerExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<InitializerExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    InitializerExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
