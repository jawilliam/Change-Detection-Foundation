namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="UsingDirectiveServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="UsingDirectiveSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void UsingDirectiveServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    UsingDirectiveServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
