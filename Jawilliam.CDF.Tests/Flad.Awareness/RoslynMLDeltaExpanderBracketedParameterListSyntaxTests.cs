namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BracketedParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BracketedParameterListSyntax> nodes);
         ...
         public void BracketedParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BracketedParameterListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BracketedParameterListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
