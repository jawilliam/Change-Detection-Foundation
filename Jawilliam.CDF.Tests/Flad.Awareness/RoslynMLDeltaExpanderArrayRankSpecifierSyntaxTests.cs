namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ArrayRankSpecifierServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ArrayRankSpecifierSyntax> nodes);
         ...
         public void ArrayRankSpecifierServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ArrayRankSpecifierSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ArrayRankSpecifierServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
