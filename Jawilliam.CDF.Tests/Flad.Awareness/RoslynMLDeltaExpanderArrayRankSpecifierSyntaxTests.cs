namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    partial class RoslynMLDeltaExpanderTests
    {
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="ArrayRankSpecifierSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void ArrayRankSpecifierServiceProvider_RoslynMLDeltaExpander_OK()
         {
    		var converter = new CDF.CSharp.RoslynML.RoslynML();
    		var selector = new CDF.CSharp.RoslynML.RoslynMLPruneSelector();
    		int id = 0; 
    
    	    IEnumerable<(ArrayRankSpecifierSyntax, ArrayRankSpecifierSyntax)> nodeRevisionPairs = null;
    	    string oExpectedLabel = null, mExpectedLabel = null;
    	    ArrayRankSpecifierServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
    		foreach(((ArrayRankSpecifierSyntax Original, ArrayRankSpecifierSyntax Modified) nodeRevisionPair, Action<RoslynML, XElement> defoliate) in nodeRevisionPairs
    			.SelectMany(n => new List<((ArrayRankSpecifierSyntax, ArrayRankSpecifierSyntax), Action<RoslynML, XElement>)>
