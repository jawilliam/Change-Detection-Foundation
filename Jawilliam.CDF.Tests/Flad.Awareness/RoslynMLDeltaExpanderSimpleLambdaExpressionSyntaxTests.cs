namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void SimpleLambdaExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<SimpleLambdaExpressionSyntax> nodes);
         ...
         public void SimpleLambdaExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<SimpleLambdaExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    SimpleLambdaExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
