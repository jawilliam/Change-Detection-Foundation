namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="SimpleLambdaExpressionServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="SimpleLambdaExpressionSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void SimpleLambdaExpressionServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    SimpleLambdaExpressionServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
