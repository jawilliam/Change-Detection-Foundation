namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ArrayCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ArrayCreationExpressionSyntax> nodes);
         ...
         public void ArrayCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ArrayCreationExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ArrayCreationExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
