namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void SingleVariableDesignationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<SingleVariableDesignationSyntax> nodes);
         ...
         public void SingleVariableDesignationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<SingleVariableDesignationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    SingleVariableDesignationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
