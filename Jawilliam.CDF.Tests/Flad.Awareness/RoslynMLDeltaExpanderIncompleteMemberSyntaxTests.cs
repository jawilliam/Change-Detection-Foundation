namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void IncompleteMemberServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<IncompleteMemberSyntax> nodes);
         ...
         public void IncompleteMemberServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<IncompleteMemberSyntax> nodes = null;
    	    string expectedLabel = null;
    	    IncompleteMemberServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
