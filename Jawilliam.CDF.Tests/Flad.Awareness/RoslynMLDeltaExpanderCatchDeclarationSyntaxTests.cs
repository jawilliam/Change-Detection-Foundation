namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void CatchDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<CatchDeclarationSyntax> nodes);
         ...
         public void CatchDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<CatchDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    CatchDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
