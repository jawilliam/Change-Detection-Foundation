namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    partial class RoslynMLDeltaExpanderTests
    {
         ...
         public void CatchDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    CatchDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodeRevisionPairs);
    				...
    				{ (n, (r, n1) => { }), (n, (r, n1) => r.Defoliate(n1)) }))
    		{
    			...
    			existingProperties = (oFullElement.Elements().Any(e => e.Label() == "Identifier") &&
