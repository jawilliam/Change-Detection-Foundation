namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void EqualsValueClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<EqualsValueClauseSyntax> nodes);
         ...
         public void EqualsValueClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<EqualsValueClauseSyntax> nodes = null;
    	    string expectedLabel = null;
    	    EqualsValueClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
