namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ClassDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ClassDeclarationSyntax> nodes);
         ...
         public void ClassDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ClassDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ClassDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
