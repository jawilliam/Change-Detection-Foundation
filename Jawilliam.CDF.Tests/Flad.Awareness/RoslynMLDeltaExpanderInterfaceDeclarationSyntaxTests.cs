namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void InterfaceDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<InterfaceDeclarationSyntax> nodes);
         ...
         public void InterfaceDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<InterfaceDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    InterfaceDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
