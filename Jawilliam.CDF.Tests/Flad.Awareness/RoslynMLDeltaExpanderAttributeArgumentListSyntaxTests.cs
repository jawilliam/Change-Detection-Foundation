namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AttributeArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AttributeArgumentListSyntax> nodes);
         ...
         public void AttributeArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AttributeArgumentListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AttributeArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
