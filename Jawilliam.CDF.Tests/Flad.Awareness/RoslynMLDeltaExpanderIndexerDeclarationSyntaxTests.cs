namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void IndexerDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<IndexerDeclarationSyntax> nodes);
         ...
         public void IndexerDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<IndexerDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    IndexerDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
