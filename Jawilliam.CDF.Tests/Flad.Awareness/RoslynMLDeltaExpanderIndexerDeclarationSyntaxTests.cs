namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="IndexerDeclarationServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="IndexerDeclarationSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void IndexerDeclarationServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    IndexerDeclarationServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
