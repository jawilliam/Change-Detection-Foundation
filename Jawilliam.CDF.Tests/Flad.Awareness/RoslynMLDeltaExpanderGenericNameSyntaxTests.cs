namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void GenericNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<GenericNameSyntax> nodes);
         ...
         public void GenericNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<GenericNameSyntax> nodes = null;
    	    string expectedLabel = null;
    	    GenericNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
