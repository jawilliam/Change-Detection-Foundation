namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void WhileStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<WhileStatementSyntax> nodes);
         ...
         public void WhileStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<WhileStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    WhileStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
