namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void DefaultSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<DefaultSwitchLabelSyntax> nodes);
         ...
         public void DefaultSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<DefaultSwitchLabelSyntax> nodes = null;
    	    string expectedLabel = null;
    	    DefaultSwitchLabelServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
