namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TupleTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TupleTypeSyntax> nodes);
         ...
         public void TupleTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TupleTypeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TupleTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
