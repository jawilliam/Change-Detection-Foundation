namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void MemberBindingExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<MemberBindingExpressionSyntax> nodes);
         ...
         public void MemberBindingExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<MemberBindingExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    MemberBindingExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
