namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void DeclarationPatternServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<DeclarationPatternSyntax> nodes);
         ...
         public void DeclarationPatternServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<DeclarationPatternSyntax> nodes = null;
    	    string expectedLabel = null;
    	    DeclarationPatternServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
