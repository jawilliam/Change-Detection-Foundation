namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AttributeListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AttributeListSyntax> nodes);
         ...
         public void AttributeListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AttributeListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AttributeListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
