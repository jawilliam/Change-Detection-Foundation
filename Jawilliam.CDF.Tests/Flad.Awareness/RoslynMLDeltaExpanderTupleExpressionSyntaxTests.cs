namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TupleExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TupleExpressionSyntax> nodes);
         ...
         public void TupleExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TupleExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TupleExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
