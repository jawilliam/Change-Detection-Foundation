namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void IfStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<IfStatementSyntax> nodes);
         ...
         public void IfStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<IfStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    IfStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
