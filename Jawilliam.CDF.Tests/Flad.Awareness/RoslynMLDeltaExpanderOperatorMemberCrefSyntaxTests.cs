namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void OperatorMemberCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<OperatorMemberCrefSyntax> nodes);
         ...
         public void OperatorMemberCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<OperatorMemberCrefSyntax> nodes = null;
    	    string expectedLabel = null;
    	    OperatorMemberCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
