namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void LabeledStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<LabeledStatementSyntax> nodes);
         ...
         public void LabeledStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<LabeledStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    LabeledStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
