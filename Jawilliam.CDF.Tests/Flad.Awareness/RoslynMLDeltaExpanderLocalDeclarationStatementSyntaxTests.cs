namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void LocalDeclarationStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<LocalDeclarationStatementSyntax> nodes);
         ...
         public void LocalDeclarationStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<LocalDeclarationStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    LocalDeclarationStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
