namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void OperatorDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<OperatorDeclarationSyntax> nodes);
         ...
         public void OperatorDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<OperatorDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    OperatorDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
