namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="OperatorDeclarationServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="OperatorDeclarationSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void OperatorDeclarationServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    OperatorDeclarationServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
