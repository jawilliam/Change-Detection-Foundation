namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void SkippedTokensTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<SkippedTokensTriviaSyntax> nodes);
         ...
         public void SkippedTokensTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<SkippedTokensTriviaSyntax> nodes = null;
    	    string expectedLabel = null;
    	    SkippedTokensTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
