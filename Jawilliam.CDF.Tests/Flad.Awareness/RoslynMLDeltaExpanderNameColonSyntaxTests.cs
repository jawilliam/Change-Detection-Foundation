namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void NameColonServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<NameColonSyntax> nodes);
         ...
         public void NameColonServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<NameColonSyntax> nodes = null;
    	    string expectedLabel = null;
    	    NameColonServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
