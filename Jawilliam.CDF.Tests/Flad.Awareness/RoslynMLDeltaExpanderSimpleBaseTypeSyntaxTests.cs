namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void SimpleBaseTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<SimpleBaseTypeSyntax> nodes);
         ...
         public void SimpleBaseTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<SimpleBaseTypeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    SimpleBaseTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
