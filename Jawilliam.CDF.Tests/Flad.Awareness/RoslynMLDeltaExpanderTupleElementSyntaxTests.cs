namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void TupleElementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<TupleElementSyntax> nodes);
         ...
         public void TupleElementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<TupleElementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    TupleElementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
    		foreach(var node in nodes)
    		{
    			...
    			existingProperties = oFullElement.Elements().Any(e => e.Name.LocalName == "Identifier") ? existingProperties : (existingProperties - 1);
    			...
    			if(oFullElement.Elements().Any(e => e.Name.LocalName == "Identifier"))
    			{
    			...
    			{
    				Assert.IsFalse(expander.FullDelta.Matches.Any(m => m.Attribute("oLb").Value == IdentifierLabel);
    			}
