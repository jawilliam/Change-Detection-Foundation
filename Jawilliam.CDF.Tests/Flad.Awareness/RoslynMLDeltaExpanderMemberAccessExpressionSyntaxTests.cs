namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void MemberAccessExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<MemberAccessExpressionSyntax> nodes);
         ...
         public void MemberAccessExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<MemberAccessExpressionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    MemberAccessExpressionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
