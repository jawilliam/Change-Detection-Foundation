namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BracketedArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BracketedArgumentListSyntax> nodes);
         ...
         public void BracketedArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BracketedArgumentListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BracketedArgumentListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
