namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AnonymousObjectMemberDeclaratorServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AnonymousObjectMemberDeclaratorSyntax> nodes);
         ...
         public void AnonymousObjectMemberDeclaratorServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AnonymousObjectMemberDeclaratorSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AnonymousObjectMemberDeclaratorServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
