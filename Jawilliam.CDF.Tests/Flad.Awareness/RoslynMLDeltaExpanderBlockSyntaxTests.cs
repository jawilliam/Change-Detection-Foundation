namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BlockServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BlockSyntax> nodes);
         ...
         public void BlockServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BlockSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BlockServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
