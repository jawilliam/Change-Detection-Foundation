namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="FromClauseServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="FromClauseSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void FromClauseServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    FromClauseServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
