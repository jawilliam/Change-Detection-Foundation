namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void GlobalStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<GlobalStatementSyntax> nodes);
         ...
         public void GlobalStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<GlobalStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    GlobalStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
