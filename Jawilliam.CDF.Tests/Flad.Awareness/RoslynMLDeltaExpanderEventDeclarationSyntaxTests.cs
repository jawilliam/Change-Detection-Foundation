namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="EventDeclarationServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="EventDeclarationSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void EventDeclarationServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    EventDeclarationServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
