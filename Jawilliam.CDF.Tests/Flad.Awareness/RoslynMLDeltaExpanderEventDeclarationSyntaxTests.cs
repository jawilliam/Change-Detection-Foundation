namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void EventDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<EventDeclarationSyntax> nodes);
         ...
         public void EventDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<EventDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    EventDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
