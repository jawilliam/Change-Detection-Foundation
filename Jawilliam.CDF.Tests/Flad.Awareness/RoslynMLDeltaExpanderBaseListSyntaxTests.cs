namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BaseListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BaseListSyntax> nodes);
         ...
         public void BaseListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BaseListSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BaseListServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
