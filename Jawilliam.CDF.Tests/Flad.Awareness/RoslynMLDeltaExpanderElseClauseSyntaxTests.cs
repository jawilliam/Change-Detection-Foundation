namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ElseClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ElseClauseSyntax> nodes);
         ...
         public void ElseClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ElseClauseSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ElseClauseServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
