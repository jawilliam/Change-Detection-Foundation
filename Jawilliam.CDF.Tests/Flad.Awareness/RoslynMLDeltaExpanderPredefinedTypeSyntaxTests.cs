namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void PredefinedTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<PredefinedTypeSyntax> nodes);
         ...
         public void PredefinedTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<PredefinedTypeSyntax> nodes = null;
    	    string expectedLabel = null;
    	    PredefinedTypeServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
