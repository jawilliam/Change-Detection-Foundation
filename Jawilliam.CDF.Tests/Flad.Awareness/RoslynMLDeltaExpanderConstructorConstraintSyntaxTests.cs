namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ConstructorConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ConstructorConstraintSyntax> nodes);
         ...
         public void ConstructorConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ConstructorConstraintSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ConstructorConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
