namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ConstructorConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<(ConstructorConstraintSyntax, ConstructorConstraintSyntax)> nodeRevisionPairs);
         ...
         public void ConstructorConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    ConstructorConstraintServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodeRevisionPairs);
