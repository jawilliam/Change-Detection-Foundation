namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void EmptyStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<EmptyStatementSyntax> nodes);
         ...
         public void EmptyStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<EmptyStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    EmptyStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
