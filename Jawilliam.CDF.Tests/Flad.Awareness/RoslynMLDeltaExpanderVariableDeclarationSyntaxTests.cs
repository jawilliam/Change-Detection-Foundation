namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void VariableDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<VariableDeclarationSyntax> nodes);
         ...
         public void VariableDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<VariableDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    VariableDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
