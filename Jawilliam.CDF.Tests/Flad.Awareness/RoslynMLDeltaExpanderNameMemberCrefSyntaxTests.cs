namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void NameMemberCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<NameMemberCrefSyntax> nodes);
         ...
         public void NameMemberCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<NameMemberCrefSyntax> nodes = null;
    	    string expectedLabel = null;
    	    NameMemberCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
