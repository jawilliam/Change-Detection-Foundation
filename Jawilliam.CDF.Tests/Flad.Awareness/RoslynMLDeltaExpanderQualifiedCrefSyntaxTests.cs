namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void QualifiedCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<QualifiedCrefSyntax> nodes);
         ...
         public void QualifiedCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<QualifiedCrefSyntax> nodes = null;
    	    string expectedLabel = null;
    	    QualifiedCrefServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
