namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void AccessorDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<AccessorDeclarationSyntax> nodes);
         ...
         public void AccessorDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<AccessorDeclarationSyntax> nodes = null;
    	    string expectedLabel = null;
    	    AccessorDeclarationServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
