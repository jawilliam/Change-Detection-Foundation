namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ArgumentServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ArgumentSyntax> nodes);
         ...
         public void ArgumentServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ArgumentSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ArgumentServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
