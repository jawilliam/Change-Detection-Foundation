namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
         /// <summary>
         /// Provides the element revision pair(s) to test in <see cref="GotoStatementServiceProvider_RoslynMLDeltaExpander_OK"/>.
         /// </summary>
    	 ...
    	 /// <summary>
         /// Tests expansion logic for <see cref="GotoStatementSyntax"/>.
         /// </summary>
    	 [TestMethod]
         public void GotoStatementServiceProvider_RoslynMLDeltaExpander_OK()
         {
    	    ...
    	    GotoStatementServiceProvider_RoslynMLDeltaExpander_DataToTest(ref nodeRevisionPairs);
