namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void BadDirectiveTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<BadDirectiveTriviaSyntax> nodes);
         ...
         public void BadDirectiveTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<BadDirectiveTriviaSyntax> nodes = null;
    	    string expectedLabel = null;
    	    BadDirectiveTriviaServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
