namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void IdentifierNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<IdentifierNameSyntax> nodes);
         ...
         public void IdentifierNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IdentifierNameServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
