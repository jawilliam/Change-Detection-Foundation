namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void ForEachStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<ForEachStatementSyntax> nodes);
         ...
         public void ForEachStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<ForEachStatementSyntax> nodes = null;
    	    string expectedLabel = null;
    	    ForEachStatementServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
