namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void SwitchSectionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<SwitchSectionSyntax> nodes);
         ...
         public void SwitchSectionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<SwitchSectionSyntax> nodes = null;
    	    string expectedLabel = null;
    	    SwitchSectionServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
