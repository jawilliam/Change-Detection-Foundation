namespace Jawilliam.CDF.Tests.Flad.Awareness
{
    ...
    {
    	 partial void NameEqualsServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref IEnumerable<NameEqualsSyntax> nodes);
         ...
         public void NameEqualsServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_OK()
         {
    	    ...
    	    IEnumerable<NameEqualsSyntax> nodes = null;
    	    string expectedLabel = null;
    	    NameEqualsServiceProvider_RoslynMLDefoliatedTopologicalAbstraction_DataToTest(ref nodes);
