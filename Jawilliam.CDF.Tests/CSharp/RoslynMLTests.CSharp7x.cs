...
namespace Jawilliam.CDF.Tests.CSharp
{
    partial class RoslynMLTests
    {
        ...
        public void WhenClauseSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            Assert.AreEqual("<WhenClause startLine=\"1\" startColumn=\"23\" endLine=\"1\" endColumn=\"41\"><Token kind=\"WhenKeyword\" Keyword=\"true\" Contextual=\"true\" startLine=\"1\" startColumn=\"23\" endLine=\"1\" endColumn=\"26\" part=\"WhenKeyword\">when</Token><BinaryExpression kind=\"GreaterThanExpression\" startLine=\"1\" startColumn=\"28\" endLine=\"1\" endColumn=\"41\" part=\"Condition\"><MemberAccessExpression kind=\"SimpleMemberAccessExpression\" startLine=\"1\" startColumn=\"28\" endLine=\"1\" endColumn=\"37\" part=\"Left\"><IdentifierName Name=\"true\" TypeSyntax=\"true\" startLine=\"1\" startColumn=\"28\" endLine=\"1\" endColumn=\"30\" part=\"Expression\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"28\" endLine=\"1\" endColumn=\"30\" part=\"Identifier\">obj</Token></IdentifierName><Token kind=\"DotToken\" Operator=\"true\" startLine=\"1\" startColumn=\"31\" endLine=\"1\" endColumn=\"31\" part=\"OperatorToken\">.</Token><IdentifierName Name=\"true\" TypeSyntax=\"true\" startLine=\"1\" startColumn=\"32\" endLine=\"1\" endColumn=\"37\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"32\" endLine=\"1\" endColumn=\"37\" part=\"Identifier\">Lenght</Token></IdentifierName></MemberAccessExpression><Token kind=\"GreaterThanToken\" startLine=\"1\" startColumn=\"39\" endLine=\"1\" endColumn=\"39\" part=\"OperatorToken\">&gt;</Token><LiteralExpression kind=\"NumericLiteralExpression\" startLine=\"1\" startColumn=\"41\" endLine=\"1\" endColumn=\"41\" part=\"Right\"><Token kind=\"NumericLiteralToken\" startLine=\"1\" startColumn=\"41\" endLine=\"1\" endColumn=\"41\" part=\"Token\">0</Token></LiteralExpression></BinaryExpression></WhenClause>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void SingleVariableDesignationSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<SingleVariableDesignation startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"1\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"1\" part=\"Identifier\">a</Token></SingleVariableDesignation>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void DiscardDesignationSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<DiscardDesignation startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"1\"><Token kind=\"UnderscoreToken\" Keyword=\"true\" Contextual=\"true\" startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"1\" part=\"UnderscoreToken\">_</Token></DiscardDesignation>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void ConstantPatternSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var node = (SwitchStatementSyntax)SyntaxFactory.ParseStatement("switch(obj){ case 'a' when obj.Lenght > 0: }");
            var xElement = converter.Visit(((CasePatternSwitchLabelSyntax)node.Sections[0].Labels[0]).Pattern);
            Assert.AreEqual("<ConstantPattern startLine=\"1\" startColumn=\"19\" endLine=\"1\" endColumn=\"21\"><LiteralExpression kind=\"CharacterLiteralExpression\" startLine=\"1\" startColumn=\"19\" endLine=\"1\" endColumn=\"21\" part=\"Expression\"><Token kind=\"CharacterLiteralToken\" startLine=\"1\" startColumn=\"19\" endLine=\"1\" endColumn=\"21\" part=\"Token\">a</Token></LiteralExpression></ConstantPattern>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void RefTypeSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<RefType startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"6\"><Token kind=\"RefKeyword\" Keyword=\"true\" startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"3\" part=\"RefKeyword\">ref</Token><IdentifierName Name=\"true\" TypeSyntax=\"true\" startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"6\" part=\"Type\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"6\" part=\"Identifier\">var</Token></IdentifierName></RefType>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
    }
}
