...
namespace Jawilliam.CDF.Tests.CSharp
{
    partial class RoslynMLTests
    {
        ...
        public void StructuredTriviaSyntax_SkippedTokensTriviaSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            Assert.AreEqual("<SkippedTokensTrivia startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"14\"><TokenList part=\"Tokens\"><Token kind=\"PublicKeyword\" Keyword=\"true\" startLine=\"1\" startColumn=\"1\" endLine=\"1\" endColumn=\"6\">public</Token><Token kind=\"VirtualKeyword\" Keyword=\"true\" startLine=\"1\" startColumn=\"8\" endLine=\"1\" endColumn=\"14\">virtual</Token></TokenList></SkippedTokensTrivia>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void TypeCrefSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<TypeCref startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"32\"><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"32\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"32\" part=\"Keyword\">int</Token></PredefinedType></TypeCref>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void IndexerMemberCrefSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<IndexerMemberCref startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"38\"><Token kind=\"ThisKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"33\" part=\"ThisKeyword\">this</Token><CrefBracketedParameterList startLine=\"2\" startColumn=\"34\" endLine=\"2\" endColumn=\"38\" part=\"Parameters\"><Token kind=\"OpenBracketToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"34\" endLine=\"2\" endColumn=\"34\" part=\"OpenBracketToken\">[</Token><SeparatedList_of_CrefParameter part=\"Parameters\"><CrefParameter startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"37\"><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"37\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"37\" part=\"Keyword\">int</Token></PredefinedType></CrefParameter></SeparatedList_of_CrefParameter><Token kind=\"CloseBracketToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"38\" endLine=\"2\" endColumn=\"38\" part=\"CloseBracketToken\">]</Token></CrefBracketedParameterList></IndexerMemberCref>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
            ...
            xElement = converter.Visit(node);
            Assert.AreEqual("<IndexerMemberCref startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"35\"><Token kind=\"ThisKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"33\" part=\"ThisKeyword\">this</Token><CrefBracketedParameterList startLine=\"2\" startColumn=\"34\" endLine=\"2\" endColumn=\"35\" part=\"Parameters\"><Token kind=\"OpenBracketToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"34\" endLine=\"2\" endColumn=\"34\" part=\"OpenBracketToken\">[</Token><Token kind=\"CloseBracketToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"35\" part=\"CloseBracketToken\">]</Token></CrefBracketedParameterList></IndexerMemberCref>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
            ...
            node = namespaceNode.DescendantNodes(descendIntoTrivia: true).OfType<IndexerMemberCrefSyntax>().Single();
            xElement = converter.Visit(node);
            Assert.AreEqual("<IndexerMemberCref startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"33\"><Token kind=\"ThisKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"33\" part=\"ThisKeyword\">this</Token></IndexerMemberCref>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void OperatorMemberCrefSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<OperatorMemberCref startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"44\"><Token kind=\"OperatorKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"37\" part=\"OperatorKeyword\">operator</Token><Token kind=\"PlusToken\" Operator=\"true\" startLine=\"2\" startColumn=\"39\" endLine=\"2\" endColumn=\"39\" part=\"OperatorToken\">+</Token><CrefParameterList startLine=\"2\" startColumn=\"40\" endLine=\"2\" endColumn=\"44\" part=\"Parameters\"><Token kind=\"OpenParenToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"40\" endLine=\"2\" endColumn=\"40\" part=\"OpenParenToken\">(</Token><SeparatedList_of_CrefParameter part=\"Parameters\"><CrefParameter startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\"><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\" part=\"Keyword\">int</Token></PredefinedType></CrefParameter></SeparatedList_of_CrefParameter><Token kind=\"CloseParenToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"44\" endLine=\"2\" endColumn=\"44\" part=\"CloseParenToken\">)</Token></CrefParameterList></OperatorMemberCref>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
            ...
            xElement = converter.Visit(node);
            Assert.AreEqual("<OperatorMemberCref startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"39\"><Token kind=\"OperatorKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"30\" endLine=\"2\" endColumn=\"37\" part=\"OperatorKeyword\">operator</Token><Token kind=\"PlusToken\" Operator=\"true\" startLine=\"2\" startColumn=\"39\" endLine=\"2\" endColumn=\"39\" part=\"OperatorToken\">+</Token></OperatorMemberCref>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void CrefBracketedParameterListSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<CrefBracketedParameterList startLine=\"2\" startColumn=\"34\" endLine=\"2\" endColumn=\"46\"><Token kind=\"OpenBracketToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"34\" endLine=\"2\" endColumn=\"34\" part=\"OpenBracketToken\">[</Token><SeparatedList_of_CrefParameter part=\"Parameters\"><CrefParameter startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"37\"><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"37\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"35\" endLine=\"2\" endColumn=\"37\" part=\"Keyword\">int</Token></PredefinedType></CrefParameter><CrefParameter startLine=\"2\" startColumn=\"40\" endLine=\"2\" endColumn=\"45\"><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"40\" endLine=\"2\" endColumn=\"45\" part=\"Type\"><Token kind=\"StringKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"40\" endLine=\"2\" endColumn=\"45\" part=\"Keyword\">string</Token></PredefinedType></CrefParameter></SeparatedList_of_CrefParameter><Token kind=\"CloseBracketToken\" Punctuation=\"true\" Language=\"true\" startLine=\"2\" startColumn=\"46\" endLine=\"2\" endColumn=\"46\" part=\"CloseBracketToken\">]</Token></CrefBracketedParameterList>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void CrefParameterSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<CrefParameter startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"47\"><Token kind=\"RefKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\" part=\"RefKindKeyword\">ref</Token><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"45\" endLine=\"2\" endColumn=\"47\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"45\" endLine=\"2\" endColumn=\"47\" part=\"Keyword\">int</Token></PredefinedType></CrefParameter>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));

            node = namespaceNode.DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single().Parameters.Parameters[1];
            xElement = converter.Visit(node);
            Assert.AreEqual("<CrefParameter startLine=\"2\" startColumn=\"50\" endLine=\"2\" endColumn=\"59\"><Token kind=\"OutKeyword\" Keyword=\"true\" TypeParameterVariance=\"true\" startLine=\"2\" startColumn=\"50\" endLine=\"2\" endColumn=\"52\" part=\"RefKindKeyword\">out</Token><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"54\" endLine=\"2\" endColumn=\"59\" part=\"Type\"><Token kind=\"StringKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"54\" endLine=\"2\" endColumn=\"59\" part=\"Keyword\">string</Token></PredefinedType></CrefParameter>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
            ...
            xElement = converter.Visit(node);
            Assert.AreEqual("<CrefParameter startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\"><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\" part=\"Keyword\">int</Token></PredefinedType></CrefParameter>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void XmlElementSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            Assert.AreEqual("<XmlElement startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"40\"><XmlElementStartTag startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"19\" part=\"StartTag\"><Token kind=\"LessThanToken\" startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"4\" part=\"LessThanToken\">&lt;</Token><XmlName startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"11\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"11\" part=\"LocalName\">message</Token></XmlName><List_of_XmlAttribute part=\"Attributes\"><XmlTextAttribute startLine=\"1\" startColumn=\"13\" endLine=\"1\" endColumn=\"18\"><XmlName startLine=\"1\" startColumn=\"13\" endLine=\"1\" endColumn=\"14\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"13\" endLine=\"1\" endColumn=\"14\" part=\"LocalName\">id</Token></XmlName><Token kind=\"EqualsToken\" Operator=\"true\" startLine=\"1\" startColumn=\"15\" endLine=\"1\" endColumn=\"15\" part=\"EqualsToken\">=</Token><Token kind=\"DoubleQuoteToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"16\" endLine=\"1\" endColumn=\"16\" part=\"StartQuoteToken\">\"</Token><TokenList part=\"TextTokens\"><Token kind=\"XmlTextLiteralToken\" startLine=\"1\" startColumn=\"17\" endLine=\"1\" endColumn=\"17\">5</Token></TokenList><Token kind=\"DoubleQuoteToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"18\" endLine=\"1\" endColumn=\"18\" part=\"EndQuoteToken\">\"</Token></XmlTextAttribute></List_of_XmlAttribute><Token kind=\"GreaterThanToken\" startLine=\"1\" startColumn=\"19\" endLine=\"1\" endColumn=\"19\" part=\"GreaterThanToken\">&gt;</Token></XmlElementStartTag><List_of_XmlNode part=\"Content\"><XmlText startLine=\"1\" startColumn=\"20\" endLine=\"1\" endColumn=\"30\"><TokenList part=\"TextTokens\"><Token kind=\"XmlTextLiteralToken\" startLine=\"1\" startColumn=\"20\" endLine=\"1\" endColumn=\"30\">Hello World</Token></TokenList></XmlText></List_of_XmlNode><XmlElementEndTag startLine=\"1\" startColumn=\"31\" endLine=\"1\" endColumn=\"40\" part=\"EndTag\"><Token kind=\"LessThanSlashToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"31\" endLine=\"1\" endColumn=\"32\" part=\"LessThanSlashToken\">&lt;/</Token><XmlName startLine=\"1\" startColumn=\"33\" endLine=\"1\" endColumn=\"39\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"33\" endLine=\"1\" endColumn=\"39\" part=\"LocalName\">message</Token></XmlName><Token kind=\"GreaterThanToken\" startLine=\"1\" startColumn=\"40\" endLine=\"1\" endColumn=\"40\" part=\"GreaterThanToken\">&gt;</Token></XmlElementEndTag></XmlElement>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
            ...
            xElement = converter.Visit(node.Content.Single());
            Assert.AreEqual("<XmlElement startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"33\"><XmlElementStartTag startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"12\" part=\"StartTag\"><Token kind=\"LessThanToken\" startLine=\"1\" startColumn=\"4\" endLine=\"1\" endColumn=\"4\" part=\"LessThanToken\">&lt;</Token><XmlName startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"11\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"11\" part=\"LocalName\">message</Token></XmlName><Token kind=\"GreaterThanToken\" startLine=\"1\" startColumn=\"12\" endLine=\"1\" endColumn=\"12\" part=\"GreaterThanToken\">&gt;</Token></XmlElementStartTag><List_of_XmlNode part=\"Content\"><XmlText startLine=\"1\" startColumn=\"13\" endLine=\"1\" endColumn=\"23\"><TokenList part=\"TextTokens\"><Token kind=\"XmlTextLiteralToken\" startLine=\"1\" startColumn=\"13\" endLine=\"1\" endColumn=\"23\">Hello World</Token></TokenList></XmlText></List_of_XmlNode><XmlElementEndTag startLine=\"1\" startColumn=\"24\" endLine=\"1\" endColumn=\"33\" part=\"EndTag\"><Token kind=\"LessThanSlashToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"24\" endLine=\"1\" endColumn=\"25\" part=\"LessThanSlashToken\">&lt;/</Token><XmlName startLine=\"1\" startColumn=\"26\" endLine=\"1\" endColumn=\"32\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"26\" endLine=\"1\" endColumn=\"32\" part=\"LocalName\">message</Token></XmlName><Token kind=\"GreaterThanToken\" startLine=\"1\" startColumn=\"33\" endLine=\"1\" endColumn=\"33\" part=\"GreaterThanToken\">&gt;</Token></XmlElementEndTag></XmlElement>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void XmlElementEndTagSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            Assert.AreEqual("<XmlElementEndTag startLine=\"1\" startColumn=\"39\" endLine=\"1\" endColumn=\"48\"><Token kind=\"LessThanSlashToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"39\" endLine=\"1\" endColumn=\"40\" part=\"LessThanSlashToken\">&lt;/</Token><XmlName startLine=\"1\" startColumn=\"41\" endLine=\"1\" endColumn=\"47\" part=\"Name\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"41\" endLine=\"1\" endColumn=\"47\" part=\"LocalName\">message</Token></XmlName><Token kind=\"GreaterThanToken\" startLine=\"1\" startColumn=\"48\" endLine=\"1\" endColumn=\"48\" part=\"GreaterThanToken\">&gt;</Token></XmlElementEndTag>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void XmlPrefixSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            Assert.AreEqual("<XmlPrefix startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"6\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"5\" part=\"Prefix\">d</Token><Token kind=\"ColonToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"6\" endLine=\"1\" endColumn=\"6\" part=\"ColonToken\">:</Token></XmlPrefix>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));

            node = (DocumentationCommentTriviaSyntax)SyntaxFactory.ParseSyntaxTree("///<a:foo id=\"3\"/>").GetCompilationUnitRoot().EndOfFileToken.LeadingTrivia.Single().GetStructure();
            xElement = converter.Visit(node.Content.OfType<XmlEmptyElementSyntax>().Single().Name.Prefix);
            Assert.AreEqual("<XmlPrefix startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"6\"><Token kind=\"IdentifierToken\" startLine=\"1\" startColumn=\"5\" endLine=\"1\" endColumn=\"5\" part=\"Prefix\">a</Token><Token kind=\"ColonToken\" Punctuation=\"true\" Language=\"true\" startLine=\"1\" startColumn=\"6\" endLine=\"1\" endColumn=\"6\" part=\"ColonToken\">:</Token></XmlPrefix>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void XmlTextSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            Assert.AreEqual("<XmlText startLine=\"1\" startColumn=\"9\" endLine=\"1\" endColumn=\"11\"><TokenList part=\"TextTokens\"><Token kind=\"XmlTextLiteralToken\" startLine=\"1\" startColumn=\"9\" endLine=\"1\" endColumn=\"11\">bar</Token></TokenList></XmlText>", RemovePosAndLength(xElement).ToString(SaveOptions.DisableFormatting));
        }
