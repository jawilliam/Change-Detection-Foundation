...
namespace Jawilliam.CDF.Tests.CSharp
{
    partial class RoslynMLTests
    {
        ...
        public void CrefParameterSyntax_RoslynMLFromRoslyn_OK()
        {
            ...
            var xElement = converter.Visit(node);
            Assert.AreEqual("<CrefParameter startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"47\"><Token kind=\"RefKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"41\" endLine=\"2\" endColumn=\"43\" part=\"RefKindKeyword\">ref</Token><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"45\" endLine=\"2\" endColumn=\"47\" part=\"Type\"><Token kind=\"IntKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"45\" endLine=\"2\" endColumn=\"47\" part=\"Keyword\">int</Token></PredefinedType></CrefParameter>", xElement.ToString(SaveOptions.DisableFormatting));

            node = namespaceNode.DescendantNodes(descendIntoTrivia: true).OfType<OperatorMemberCrefSyntax>().Single().Parameters.Parameters[1];
            xElement = converter.Visit(node);
            Assert.AreEqual("<CrefParameter startLine=\"2\" startColumn=\"50\" endLine=\"2\" endColumn=\"59\"><Token kind=\"OutKeyword\" Keyword=\"true\" TypeParameterVariance=\"true\" startLine=\"2\" startColumn=\"50\" endLine=\"2\" endColumn=\"52\" part=\"RefKindKeyword\">out</Token><PredefinedType TypeSyntax=\"true\" startLine=\"2\" startColumn=\"54\" endLine=\"2\" endColumn=\"59\" part=\"Type\"><Token kind=\"StringKeyword\" Keyword=\"true\" startLine=\"2\" startColumn=\"54\" endLine=\"2\" endColumn=\"59\" part=\"Keyword\">string</Token></PredefinedType></CrefParameter>", xElement.ToString(SaveOptions.DisableFormatting));
