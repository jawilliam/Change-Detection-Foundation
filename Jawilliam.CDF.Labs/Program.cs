...
namespace Jawilliam.CDF.Labs
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            report.AppendLine("Project;#Commits;#Contributors;#Branches;#FileVersions;#FileChanges;#FileAdded;#FileDeleted;#FileModified;#FileRenamed");
            foreach (var project in Projects)
            {
                Console.Out.WriteLine($"Collecting the report of {project.Name}");
                var dbRepository = new GitRepository(project.Name) { Name = project.Name };report.AppendLine($"{project.Name};" +
