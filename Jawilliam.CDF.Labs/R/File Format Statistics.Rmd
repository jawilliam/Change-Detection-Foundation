...
Cet(10)-Cit(32)
```{r echo=FALSE}
BetweenSymptomsStats <- read_delim("D:/ExperimentLogs/BetweenSymptomsStats_10_32.txt", ";", escape_double = FALSE, trim_ws = TRUE, col_types = cols(
  .default = col_double(),
  Project = col_character(),
  PrincipalRevisionPair = col_character()
))
...
Cet(10)-Det(28)
```{r echo=FALSE}
BetweenSymptomsStats <- read_delim("D:/ExperimentLogs/BetweenSymptomsStats_10_28.txt", ";", escape_double = FALSE, trim_ws = TRUE, col_types = cols(
  .default = col_double(),
  Project = col_character(),
  PrincipalRevisionPair = col_character()
))
...
Cet(10)-Dit(30)
```{r echo=FALSE}
BetweenSymptomsStats <- read_delim("D:/ExperimentLogs/BetweenSymptomsStats_10_30.txt", ";", escape_double = FALSE, trim_ws = TRUE, col_types = cols(
  .default = col_double(),
  Project = col_character(),
  PrincipalRevisionPair = col_character()
))
